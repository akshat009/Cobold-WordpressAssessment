                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                        <div class="features-small-item">
                            <div class="icon">
                                /
                                <i><img src=" <?php echo  get_template_directory_uri(); ?>/assets/images/featured-item-01.png" alt=""></i>
                            </div>
                            <h5 class="features-title">Modern Strategy</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque velit metus.</p>
                        </div>
                    </div>
